...
const DownlaodButton = () => {
  ...
  return (
    <button
      ...
      href="#_"
      class="relative inline-flex items-center justify-center  p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-2xl shadow-2xl group "
    >
      ...
      <span class="relative text-white font-semibold">Capabilities</span>
    </button>
  );
};
